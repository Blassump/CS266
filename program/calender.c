...
gotoxy(20, y+2);
    switch(mon){
    	case 1 :
    		...
    		gotoxy(20, y+3);
    		printf("8th : National Children's Day");
    		gotoxy(20, y+4);
    		printf("16th : National Teachers' Day");
    		break;
    	case 2 :
    		printf("1th : Chinese New Year's Day");
    		gotoxy(20, y+3);
    		printf("14th : Valentine's Day");
    		gotoxy(20, y+4);
    		printf("16th : Makha Bucha Day");
    		break;
    	case 3 :
...
//    		printf("24th : World Tuberculosis Day");
    	...
    	case 4 :
    		...
    		gotoxy(20, y+3);
    		printf("6th : Chakri Day");
    		gotoxy(20, y+4);
    		printf("13 - 15th : Songkran Day");
    		break;
    	case 5 :
    		printf("1th : National *Labour Day");
    		gotoxy(20, y+3);
    		printf("4th : Coronation Day");
    		gotoxy(20, y+4);
    		printf("13th : Royal Ploughing Ceremony Day");
    		gotoxy(20, y+5);
    		printf("15th : Visakha Bucha Day");
    		break;
    	case 6 :
    		printf("3th : H.M. Queen Suthida");
    		gotoxy(20, y+3);
    		printf("      Bajrasudhabimalalakshana’s Birthday");
    		break;
    	case 7 :
    		printf("13st : Asarnha Bucha Day");
    		gotoxy(20, y+3);
    		printf("14th : Buddhist Lent Day");
    		gotoxy(20, y+4);
    		printf("28th : His Majesty King Maha Vajiralongkorn");
    		gotoxy(20, y+5);
    		printf("       Phra Vajiraklaochaoyuhua’s Birthday");
    		break;
    	case 8 :
    		printf("12th : Thai Mother's Day");
    		break;
    	case 9 :
    		printf("10st : Chinese Lunar Day");
    		gotoxy(20, y+3);
    		printf("25th : Thai Festival at ");
    		gotoxy(20, y+4);
    		printf("       the End of 10th Lunar Month");
    		break;
    	case 10 :
    		printf("10th : Ecclesiastical Ceremony at ");
    		gotoxy(20, y+3);
    		printf("       the End of Rainy Season Retreat");
			gotoxy(20, y+4);
    		...
    		break;
    	case 11 :
    		printf("8th : Loy Krathong Day");
    		break;
    	case 12 :
    		printf("5st : Father's Day");
    		gotoxy(20, y+3);
